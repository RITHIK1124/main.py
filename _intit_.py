...
class Microphone(AudioSource):
    ...
    def get_pyaudio():
        ...
        if LooseVersion(pyaudio.__version__) < LooseVersion("0.2.14"):
            raise AttributeError("PyAudio 0.2.14 or later is required (found version {})".format(pyaudio.__version__))
        return pyaudio
